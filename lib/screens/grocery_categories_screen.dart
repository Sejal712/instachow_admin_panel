...
import 'grocery_category_edit_screen.dart';
...
class _GroceryCategoriesScreenState extends State<GroceryCategoriesScreen> {
  ...
  Future<void> _addGroceryCategory() async {
    ...
    try {
      await GroceryApiService.addGroceryCategory(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Grocery category added successfully!'),
          backgroundColor: Colors.green,
        ),
      );
      
      await _loadGroceryCategories();
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
  ...
  Future<void> _deleteCategory(int categoryId) async {
    try {
      final success = await GroceryApiService.deleteGroceryCategory(categoryId);
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 16),
                          ElevatedButton(
                            onPressed: _isAddingCategory ? null : _addGroceryCategory,
                            ...
                            ? Center(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 8),
                                    Text(
                                      'Add your first grocery category above',
                                      style: TextStyle(
                                        fontSize: 14,
                                              ...
                                              IconButton(
                                                ...
                                                onPressed: () async {
                                                  final result = await Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                      builder: (context) => GroceryCategoryEditScreen(
                                                        category: category,
                                                      ),
                                                    ),
                                                  );
  ...
  Widget _buildLanguageTab(String title, bool isActive) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isActive ? Colors.teal[600] : Colors.transparent,
        borderRadius: BorderRadius.circular(4),
        border: Border.all(
