...
class GrocerySubCategoriesScreen extends StatefulWidget {
  const GrocerySubCategoriesScreen({super.key});

  @override
  State<GrocerySubCategoriesScreen> createState() => _GrocerySubCategoriesScreenState();
}

class _GrocerySubCategoriesScreenState extends State<GrocerySubCategoriesScreen> {
  ...
  Future<void> _loadMasterCategories() async {
    try {
      final categories = await GroceryApiService.getGroceryCategories();
      setState(() {
        _masterCategories = categories;
      });
    } catch (e) {
      ApiConfig.debugLog('Error loading grocery master categories: $e');
    }
  }
  ...
  Future<void> _loadSubCategories() async {
    ...
    try {
      ApiConfig.debugLog('Loading grocery sub-categories');
      
      // Get all grocery sub-categories
      final allSubCategories = await GroceryApiService.getGrocerySubCategories();
      ApiConfig.debugLog('Retrieved ${allSubCategories.length} grocery sub-categories');
      ...
      ApiConfig.debugLog('Successfully loaded ${allSubCategories.length} grocery sub-categories');
    } catch (e) {
      setState(() {
        _isLoading = false;
        _subCategories = [];
      });
      ApiConfig.debugLog('Error loading grocery sub-categories: $e');
      if (mounted) {
  ...
  Future<void> _addSubCategory() async {
    ...
    try {
      await GroceryApiService.addGrocerySubCategory(
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Grocery sub-category added successfully!'),
  ...
  Future<void> _updateSubCategory() async {
    ...
    try {
      await GroceryApiService.updateGrocerySubCategory(
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Grocery sub-category updated successfully!'),
            backgroundColor: Colors.green,
          ),
        );
      }
  ...
  Future<void> _deleteSubCategory(String id, String name) async {
    ...
    if (confirmed == true) {
      try {
        await GroceryApiService.deleteGrocerySubCategory(id);
        await _loadSubCategories();
        
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Grocery sub-category deleted successfully!'),
              backgroundColor: Colors.green,
            ),
          );
        }
  ...
  void _editSubCategory(Map<String, dynamic> subCategory) async {
    setState(() {
      ...
      _selectedMasterCategoryId = subCategory['master_cat_grocery_id'].toString();
    });
  }
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  'Grocery Sub Categories Management',
                  style: TextStyle(
                    fontSize: 28,
            ...
            Text(
              'Manage sub-categories for Grocery module',
              style: TextStyle(
                fontSize: 16,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        _editingSubCategoryId != null ? 'Edit Grocery Sub Category' : 'Add New Grocery Sub Category',
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'New grocery sub category',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Select Grocery Category',
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(8),
                                ),
                                contentPadding: const EdgeInsets.symmetric(
                            ...
                            ? Center(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'No grocery sub-categories found',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Colors.grey[600],
                                      ),
                                    ...
                                    const SizedBox(height: 8),
                                    Text(
                                      'Add your first grocery sub-category above',
                                      style: TextStyle(
                                        fontSize: 14,
